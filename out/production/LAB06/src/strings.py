...
A program that implements several of the built in string functions as
separate functions.
...
def str_reverse(src: str) -> str:
    """
    Reverse a string, src
    :param src: the string to reverse
...
def test_index() -> None:
    ...
    print('str_index("c", "ab") -> -1:',
          'OK' if str_index("c", "ab") == -1 else 'FAIL! got: ' + str(str_index("c", "ab")))
